"""
---------------------------------- Link for the challenge: https://codeforces.com/problemset/problem/664/A ------------------------------
...
To make the problem even more complicated we allow a and b to be up to googol, 10100 — such number do not fit even in 64-bit integer type!
