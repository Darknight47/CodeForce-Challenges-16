"""
------------------------------------- Link for the challenge: https://codeforces.com/problemset/problem/1114/A -------------------------------------
...
Can you please find out whether it's possible to distribute grapes so that everyone is happy or Aki has to buy some more grapes?
...
YES
"""
andrew, dimitry, michael = map(int, input().split())
green, purple, black = map(int, input().split())
ok = True
if(andrew > green):
    ok = False
else:
