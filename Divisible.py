"""
------------------------------------ Link for the challenge: https://codeforces.com/problemset/problem/1096/A ------------------------------------
...
Output
Print T lines, each line should contain the answer — two integers x and y such that l≤x,y≤r, x≠y and x divides y. 
The answer in the i-th line should correspond to the i-th query from the input.
